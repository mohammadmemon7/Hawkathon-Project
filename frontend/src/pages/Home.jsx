...
export default function Home() {
  ...
  // Fallback if patient not set
  const patientName = currentPatient?.name || 'Ramesh Kumar';

  const t = {
    healthStatus: language === 'hi' ? 'स्वास्थ्य स्थिति: सामान्य' : 'Health Status: Normal',
    greeting: language === 'hi' ? `नमस्ते, ${patientName} जी` : `Namaste, ${patientName} Ji`,
    subtitle: language === 'hi' ? 'आज आप कैसा महसूस कर रहे हैं? SehatSetu AI आपकी सहायता के लिए यहाँ है।' : 'How are you feeling today? SehatSetu AI is here to help you.',
    checkSymptomsBtn: language === 'hi' ? 'अभी लक्षण जांचें' : 'Check Symptoms Now',
    talkToDoctorBtn: language === 'hi' ? 'डॉक्टर से बात करें' : 'Talk to Doctor',
    quickActions: language === 'hi' ? 'त्वरित कार्रवाई' : 'Quick Actions',
    seeAll: language === 'hi' ? 'सभी देखें' : 'See all',
    symptomCheckTitle: language === 'hi' ? 'AI लक्षण जांच' : 'AI Symptom Check',
    symptomCheckSub: language === 'hi' ? 'प्रारंभिक जांच प्राप्त करें' : 'Get initial triage',
    talkToDoctorTitle: language === 'hi' ? 'डॉक्टर से बात करें' : 'Talk to Doctor',
    talkToDoctorSub: language === 'hi' ? 'वीडियो परामर्श' : 'Video consultation',
    myRecordsTitle: language === 'hi' ? 'मेरे रिकॉर्ड' : 'My Records',
    myRecordsSub: language === 'hi' ? 'प्रिस्क्रिप्शन देखें' : 'View prescriptions',
    orderMedicinesTitle: language === 'hi' ? 'दवाइयां मंगाएं' : 'Order Medicines',
    orderMedicinesSub: language === 'hi' ? 'फार्मेसी निर्देशिका' : 'Pharmacy directory',
  };
  ...
  return (
    <div className="p-6 md:p-8 space-y-8 pb-20 md:pb-8">
      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-teal-700 to-[var(--primary)] text-white p-8 md:p-12 shadow-xl shadow-teal-900/10">
        ...
        <div className="relative z-10 max-w-2xl">
          ...
          <h1 className="text-3xl md:text-5xl font-bold mb-4 tracking-tight leading-tight">
            {t.greeting} <span className="inline-block animate-wave origin-bottom-right">🙏</span>
          </h1>
          
          <p className="text-teal-100/90 text-lg md:text-xl font-medium mb-8 max-w-xl">
            {t.subtitle}
          </p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
        ...
        <button 
          onClick={() => navigate('/symptoms')}
          className="group relative overflow-hidden bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md hover:border-green-200 transition-all text-left flex flex-col justify-between min-h-[160px]"
        >
          ...
          <div className="w-12 h-12 bg-green-100 text-green-600 rounded-xl flex items-center justify-center mb-4 group-hover:-translate-y-1 transition-transform shadow-sm">
            <Stethoscope size={24} />
          </div>
          <div>
        ...
        <button 
          onClick={() => navigate('/talk')}
          className="group relative overflow-hidden bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md hover:border-teal-200 transition-all text-left flex flex-col justify-between min-h-[160px]"
        >
          ...
          <div className="w-12 h-12 bg-teal-100 text-[var(--primary)] rounded-xl flex items-center justify-center mb-4 group-hover:-translate-y-1 transition-transform shadow-sm">
            <Video size={24} />
          </div>
          <div>
        ...
        <button 
          ...
          className="group relative overflow-hidden bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md hover:border-blue-200 transition-all text-left flex flex-col justify-between min-h-[160px]"
        >
          ...
          <div className="w-12 h-12 bg-blue-100 text-blue-600 rounded-xl flex items-center justify-center mb-4 group-hover:-translate-y-1 transition-transform shadow-sm">
        ...
        <button 
          ...
          className="group relative overflow-hidden bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md hover:border-orange-200 transition-all text-left flex flex-col justify-between min-h-[160px]"
        >
          ...
          <div className="w-12 h-12 bg-orange-100 text-orange-600 rounded-xl flex items-center justify-center mb-4 group-hover:-translate-y-1 transition-transform shadow-sm">
            <Pill size={24} />
          </div>
          <div>
