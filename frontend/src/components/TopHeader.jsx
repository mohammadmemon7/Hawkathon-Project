...
export default function TopHeader({ onMenuClick }) {
  ...
  const activeUserName = activeUser?.name || 'Ramesh Kumar';
  const activeUserId = activeUser?.id || 'PT-8932';
      ...
      <div className="flex items-center gap-3 md:gap-5">
        ...
        <div className="flex items-center gap-3 border-l border-gray-100 pl-3 md:pl-5">
          <div className="hidden md:flex flex-col items-end">
            ...
            <span className="text-xs text-gray-400 font-medium tracking-wide">{activeUserLabel} {activeUserId}</span>
          </div>
